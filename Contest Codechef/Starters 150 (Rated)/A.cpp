...
void test_case()
{
    ...
    // minDiff=min(abs(2*a-b),minDiff);
    // minDiff=min(minDiff,abs(2*b-a));
    // if(a%2==0) {
    //     minDiff=min(minDiff,abs(a/2-b));
    // }
    // else{
    //     minDiff=min(minDiff,abs(abs(a/2-b))+1);
    // }
    // if(b%2==0) {
    //     minDiff=min(minDiff,abs(b/2-a));
    // }
    // else{
    //     minDiff=min(minDiff,abs(b/2-a)+1);
    // }
    minDiff=min(abs(a/2-b),abs(b/2-a));
    cout<<minDiff<<endl;
