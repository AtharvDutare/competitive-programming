...
void test_case()
{
    ...
    vll even2=even;
    ll maxOdd2=maxOdd;
    sort(even2.begin(),even2.end(),greater<int>());
    //cout<<maxOdd<<endl;
    sort(even.begin(),even.end());
    if(evenParity==0||evenParity==n) {
        cout<<0<<endl;
        return;
    }
    ll ans=0,ans1=0;
    ...
    // cout<<endl;
    for(int i=0;i<even.size();i++) {
        //cout<<maxOdd<<" "<<arr[i]<<endl;
        if(maxOdd>even[i]) {
            ans++;
            maxOdd=maxOdd+even[i];
        }
        else{
            maxOdd=maxOdd+2*even[i];
            ans+=2;
        }
    }
    for(int i=0;i<even2.size();i++) {
        ...
        if(maxOdd2>even2[i]) {
            ans1++;
            maxOdd2=maxOdd2+even2[i];
        }
        else{
            maxOdd2=maxOdd2+2*even2[i];
            ans1+=2;
        }
    }
