...
void test_case()
{
    ...
    // first l mapp to last R
    // second L mapp to Second Last R and so on
    ll l=0;
    ll r=n-1;
    ll ans=0;
    ll cumSum=0;
